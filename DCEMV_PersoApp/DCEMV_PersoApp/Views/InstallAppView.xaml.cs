...
{
    public partial class InstallAppView : ModalPage
    {
        private ICardInterfaceManger cardInterfaceManger;
        private GPPersoTerminalApplication cardApp;
        
        public InstallAppView(ICardInterfaceManger cardInterfaceManger)
		{
			InitializeComponent();
            ...
            //txtPackageAID.Text = "A000000060";
            //txtExecutableModuleAID.Text = "A0000000600101";
            //txtAppletAID.Text = "325041592E5359532E4444463031";
        ...
        private void cmdOK_Clicked(object sender, EventArgs e)
        {
            StopCardScanner();
            StartCardScanner();
            cardApp.InstallApp(txtSecurityDomain.Text, txtMasterKey.Text, txtPackageAID.Text, txtExecutableModuleAID.Text, txtAppletAID.Text);
        }
