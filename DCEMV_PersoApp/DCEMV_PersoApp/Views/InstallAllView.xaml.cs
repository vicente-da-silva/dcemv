...
{
    public partial class InstallAllView : ModalPage
    {
        ...
        private void cmdOK_Clicked(object sender, EventArgs e)
        {
            StopCardScanner();
            StartCardScanner();
            cardApp.All(txtCapFilePath.Text,txtSecurityDomain.Text, txtMasterKey.Text, txtPackageAID.Text, txtExecutableModuleAID.Text, txtAppletAID.Text);
        }
