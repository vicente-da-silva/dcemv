...
{
    public class NCIConfig
    {
#if NXP_CORE_CONF
        byte[] NxpNci_CORE_CONF = new byte[]{0x20, 0x02, 0x07, 0x01, 	/* CORE_SET_CONFIG_CMD */
	0x33, 0x04, 0x04, 0x03, 0x02, 0x01,				/* LA_NFCID1 */
        ...
        byte[] NxpNci_CORE_CONF_EXTN = new byte[]{0x20, 0x02, 0x05, 0x01, 	/* CORE_SET_CONFIG_CMD */
	0xA0, 0x40, 0x01, 0x01,								/* READER_TAG_DETECTOR_CFG */
         ...
         */
#if NXP_CORE_STANDBY
        byte[] NxpNci_CORE_STANDBY = new byte[] { 0x2F, 0x00, 0x01, 0x01 }; /* last byte indicates enable/disable */
#endif
        ...
        */
        ...
        public static byte[] NxpNci_RF_CONF_1stGen = new byte[] { };
        ...
        public static byte[] NxpNci_RF_CONF_2ndGen = new byte[]{0x20, 0x02, 0xB7, 0x14,
