...
{
    public class RFManagementCommand : ControlPacket
    {
        ...
        public RFManagementCommand() : base() { }

        public RFManagementCommand(PacketBoundryFlagEnum pbf, OpcodeRFIdentifierEnum opcodeIdentifier) 
