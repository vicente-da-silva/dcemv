...
{
    public class CoreSetConfigResponse : CoreResponse
    {
        ...
        public CoreSetConfigResponse(PacketBoundryFlagEnum pbf) : base(pbf,OpcodeCoreIdentifierEnum.CORE_SET_CONFIG_CMD) { }
