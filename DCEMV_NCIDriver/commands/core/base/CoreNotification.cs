...
{
    public class CoreNotification : NotificationPacket
    {
        public new OpcodeCoreIdentifierEnum OpcodeIdentifier
        {
            get
            {
                return (OpcodeCoreIdentifierEnum)EnumUtil.GetEnum(typeof(OpcodeCoreIdentifierEnum), base.OpcodeIdentifier);
            }
        }

        public CoreNotification() : base() { }
