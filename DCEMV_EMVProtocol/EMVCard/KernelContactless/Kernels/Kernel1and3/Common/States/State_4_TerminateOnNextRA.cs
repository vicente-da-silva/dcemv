...
namespace DCEMV.EMVProtocol.Kernels.K1K3
{
    public static class State_4_TerminateOnNextRA
    {
        ...
        private static SignalsEnum EntryPointL1RSP(KernelDatabaseBase database, KernelQ qManager, CardResponse cardResponse)
        {
        ...
        private static SignalsEnum EntryPointRA(KernelDatabaseBase database, KernelQ qManager)
        {
            return DoCommon(database, qManager);
        }
